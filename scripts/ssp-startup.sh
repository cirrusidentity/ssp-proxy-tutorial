#!/bin/bash
# 
# Enable/disable specifc SSP modules prior to starting docker
# Based on: https://github.com/cirrusidentity/docker-simplesamlphp/blob/master/ssp-startup.sh
echo "Modules to remove: $SSP_DELETE_MODULES"
